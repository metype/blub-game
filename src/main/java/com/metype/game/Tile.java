...
//       */
                ...
                // gc.setImageSmoothing(false); Only available in JavaFX 12+
                if(surrounded.length>=8) {
                    offset = (16*type*8);
                    if(surrounded[1]&&surrounded[3]&&surrounded[5]&&surrounded[7]) gc.drawImage(tileSet, 16+offset, 48, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(!surrounded[1]&&!surrounded[3]&&!surrounded[5]&&!surrounded[7]) gc.drawImage(tileSet, 96+offset, 176, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(!surrounded[1]&&surrounded[3]&&!surrounded[5]&&!surrounded[7]) gc.drawImage(tileSet, 32+offset, 176, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(!surrounded[1]&&!surrounded[3]&&surrounded[5]&&!surrounded[7]) gc.drawImage(tileSet, 48+offset, 208, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(!surrounded[1]&&surrounded[3]&&surrounded[5]&&!surrounded[7]) gc.drawImage(tileSet, 80+offset, 208, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(!surrounded[1]&&surrounded[3]&&!surrounded[5]&&surrounded[7]) gc.drawImage(tileSet, 48+offset, 176, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(!surrounded[1]&&!surrounded[3]&&!surrounded[5]&&surrounded[7]) gc.drawImage(tileSet, 64+offset, 176, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(!surrounded[1]&&!surrounded[3]&&surrounded[5]&&surrounded[7]) gc.drawImage(tileSet, 96+offset, 208, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(!surrounded[1]&&surrounded[3]&&surrounded[5]&&surrounded[7]) gc.drawImage(tileSet, 48+offset, 96, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(surrounded[1]&&surrounded[3]&&!surrounded[5]&&surrounded[7]) gc.drawImage(tileSet, 48+offset, 112, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(surrounded[1]&&surrounded[3]&&!surrounded[5]&&!surrounded[7]) gc.drawImage(tileSet, 32+offset, 112, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(surrounded[1]&&!surrounded[3]&&!surrounded[5]&&surrounded[7]) gc.drawImage(tileSet, 112+offset, 112, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(surrounded[1]&&surrounded[3]&&surrounded[5]&&!surrounded[7]) gc.drawImage(tileSet, 64+offset, 80, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(surrounded[1]&&!surrounded[3]&&surrounded[5]&&surrounded[7]) gc.drawImage(tileSet, 80+offset, 80, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(surrounded[1]&&!surrounded[3]&&surrounded[5]&&!surrounded[7]) gc.drawImage(tileSet, 48 + offset, 224, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(surrounded[1]&&!surrounded[3]&&!surrounded[5]&&!surrounded[7]) gc.drawImage(tileSet, 48+ offset, 240, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                    if(surrounded[1]&&surrounded[7]&&!surrounded[0]) gc.drawImage(tileSet, 64, 96, 5, 5, hitBox.x, hitBox.y, tileSize*(5/16f), tileSize*(5/16f));
                    if(surrounded[1]&&surrounded[3]&&!surrounded[2]) gc.drawImage(tileSet, 91, 96, 5, 5, (hitBox.x+tileSize)-(tileSize*(5/16f)), hitBox.y, tileSize*(5/16f), tileSize*(5/16f));
                    if(surrounded[5]&&surrounded[3]&&!surrounded[4]) gc.drawImage(tileSet, 91, 127, 5, 5, (hitBox.x+tileSize)-(tileSize*(5/16f)), (hitBox.y+tileSize)-(tileSize*(5/16f)), tileSize*(5/16f), tileSize*(5/16f));
                    if(surrounded[5]&&surrounded[7]&&!surrounded[6]) gc.drawImage(tileSet, 64, 127, 5, 5, hitBox.x, (hitBox.y+tileSize)-(tileSize*(5/16f)), tileSize*(5/16f), tileSize*(5/16f));
                }else{
                    gc.drawImage(tileSet, 96, 176, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                }
//                gc.drawImage(tileSet, 16, 16, 16, 16, hitBox.x, hitBox.y, tileSize, tileSize);
                break;
            case(2): // End Tile
